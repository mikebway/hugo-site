...
1. First think through the problem, read the codebase for relevant files, and write a plan to tasks/todo-###.md.
   * todo-###.md files shall be numbered, replacing the ### with 001, 002, etc. 
...
7. Maintain a CHANGES.log log file documenting each change you make as a time stamped list.
